# IF YOU ARE HOSTING MORPHOBOT ON OTHER VPS OR LOCALLY RATHER THAN HEROKU
...
class Config(object):
    ...
    ALIVE_MSG = os.environ.get("ALIVE_MSG", "😈🇮🇳u𝐥𝕥ⓡＡ ｌ𝒆ＧⒺ𝓷ĐΔＲч 𝓸𝐅 𝐭𝔼𝔞Ｍ 𝐦𝐨ℝＰʰ𝐎 ⓤᔕ𝐄ᖇ𝔹Ｏⓣ🇮🇳😈")
    ALIVE_PIC = os.environ.get("ALIVE_PIC", "https://telegra.ph/file/c14f64e88cc9bc3f07f3a.jpg")
    ...
    if AUTH_TOKEN_DATA != None:
        ...
        t_file.close()
    BIO_MSG = os.environ.get("BIO_MSG", "🇮🇳❣️india lover morpho bot😈 ")
    ...
    PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC", "https://telegra.ph/file/c14f64e88cc9bc3f07f3a.jpg")
    REMOVE_BG_API = os.environ.get("REMOVE_BG_API", None)
    SCREEN_SHOT_LAYER_ACCESS_KEY = os.environ.get("SCREEN_SHOT_LAYER_ACCESS_KEY", None)
    STICKER_PACKNAME = os.environ.get("STICKER_PACKNAME", None)
    MORPHOBOT_SESSION = os.environ.get("MORPHOBOT_SESSION", None)
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/BIHARIBABUHU/team-motpho-userbot")
